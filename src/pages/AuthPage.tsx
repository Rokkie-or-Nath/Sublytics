...
import { Mail, Lock, Diamond, ArrowRight, Shield, Zap, Eye } from 'lucide-react';
import { EmailDetection } from '../components/auth/EmailDetection';

export function AuthPage() {
  const { login, isDetecting, setIsDetecting, setDetectionProgress, setDetectionMessage } = useStore();
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-sm text-text-muted mt-1">
                Sign in to detect and manage your subscriptions
              </p>
            </div>
            ...
            <p className="text-xs text-text-muted text-center">
              Use any email and password (6+ chars) to sign in. Sublytics will scan your email for subscription activity.
            </p>
          </motion.div>
